...
const Footer = () => {
    return (
      <div>
        <footer class="bg-emerald-200 dark:bg-gray-900">
          <div class="container px-6 py-12 mx-auto">
            ...
            <div class="flex items-center justify-between">
              <div className="flex">
                ...
                <h1 className="text-sm font-mono text-emerald-600 ml-1">
                  <span className="text-xl font-bold text-emerald-800">Sk</span>
                  <p className="text-xsm font-semibold">Solution</p>
                </h1>
